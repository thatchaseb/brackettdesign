    ...
    return(
      <React.Fragment key={index}>
        ...
        <div className=' text-gray-300 px-3 my-12 grid grid-cols-4 '>
          ...
          {/*         Project Picture           */}
          <div className='object-cover hover:animate-pulse
          '>
          ...
          <div className='col-span-3 ml-4 '>
            ...
            {/*         Project Header            */}
            <div className='text-2xl pb-2 text-green-300 hover:animate-hover-top-left cursor-pointer hover:text-blue-400'>
              {item.header} 
